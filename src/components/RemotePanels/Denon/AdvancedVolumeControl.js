            ...
            <div className="flex flex-col gap-3 w-2/3 justify-end">
                ...
                <div className="flex flex-col gap-2 justify-center items-center ">
                    ...
                    <div id="dynamic-eq" className={`flex ${denonState.psDynEqOn ? 'opacity-100' : 'opacity-0'} transition-all-500`} role="group">
                        <KeypressButton remote={ remote }
                                        className={`w-1/4 ${denonState.PSREFLEV === "0" ? 'btn-primary-denon' : 'btn-secondary'}`}
                                        value="PSREFLEV 0"
                                        onClick={handleClick}
                                        disabled={denonState.loading}
                        >
                        ...
                        <KeypressButton remote={ remote }
                                        className={`w-1/4 ${denonState.PSREFLEV === "5" ? 'btn-primary-denon' : 'btn-secondary'}`}
                                        value="PSREFLEV 5"
                                        onClick={handleClick}
                                        disabled={denonState.loading}
                        >
                        ...
                        <KeypressButton remote={ remote }
                                        className={`w-1/4 ${denonState.PSREFLEV === "10" ? 'btn-primary-denon' : 'btn-secondary'}`}
                                        value="PSREFLEV 10"
                                        onClick={handleClick}
                                        disabled={denonState.loading}
                        >
                        ...
                        <KeypressButton remote={ remote }
                                        className={`w-1/4 ${denonState.PSREFLEV === "15" ? 'btn-primary-denon' : 'btn-secondary'}`}
                                        value="PSREFLEV 15"
                                        onClick={handleClick}
                                        disabled={denonState.loading}
                        >
